...
form.addEventListener('submit', async function (e) {
  ...
  try {
    if (formAction && formAction !== '#' && formAction.trim() !== '') {
      // POST to provided action (e.g., Formspree endpoint)
    ...
    console.error(err);
    alert('Unable to send message. Please try again later or use your email client.');
  } finally {
    submitBtn.innerHTML = originalBtnText;
    // keep button disabled until valid inputs
    if (form.checkValidity()) {
